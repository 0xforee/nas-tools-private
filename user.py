...
class User(UserMixin):
  ...
  },
  {
    ...
    def get_topmenus(self):
        return ['我的媒体库', '资源搜索', '探索', '站点管理', '订阅管理', '下载管理', '媒体整理', '服务', '系统设置']
    def get_services(self):
        ...
        if pt:
            ...
            svg = '''
                ...
                '''
            scheduler_cfg_list['pttransfer'] = (
                {'name': '下载文件转移', 'time': tim_pttransfer, 'state': sta_pttransfer, 'id': 'pttransfer',
                 'svg': svg,
                 'color': "green"})
            ...
            if torrent_remove_tasks:
                ...
                svg = '''
                    ...
                    '''
                scheduler_cfg_list['autoremovetorrents'] = (
